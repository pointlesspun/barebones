...
{
    public class AnyCharParseFunction : AbstractParseFunction
    {
        ...
        public override ParseResult Parse(string text, int start) => ParseAnyChar(text, start, Delimiters, EscapeChar, OnMatch, Log);
